...
export default function Layout({ children }: LayoutProps) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            <Toast />
            {user ? (
                // Authenticated header (top header)
                            ...
                            <div className="flex">
                                <div className="flex-shrink-0 flex items-center">
                                    <div className="flex flex-col">
                                        <Link href={user ? "/dashboard" : "/"} className="text-xl font-bold text-primary dark:text-indigo-400">TaxTooter</Link>
                                        <span className="text-xs text-gray-500 dark:text-gray-400">
                                            Faceless Consultancy Platform under Self Assessment Mode
                                        </span>
                                    </div>
                                </div>
                ...
                // Unauthenticated header (lower header from index.tsx)
                <nav className="bg-white dark:bg-gray-800 shadow-lg">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between h-16">
                            <div className="flex items-center">
                                <div className="flex flex-col">
                                    <Link href={user ? "/dashboard" : "/"} className="text-xl font-bold text-indigo-600 dark:text-indigo-400">TaxTooter</Link>
                                    <span className="text-xs text-gray-500 dark:text-gray-400">
                                        Faceless Consultancy Platform under Self Assessment Mode
                                    </span>
                                </div>
